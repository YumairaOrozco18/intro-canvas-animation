...
function init() {
  sun.src = "imagenes/canvas_sun.png";
  moon.src = "imagenes/canvas_moon.png";
  earth.src = "imagenes/canvas_earth.png";
  window.requestAnimationFrame(draw);
}

function draw() {
  const ctx = document.getElementById("canvasSistemaSolar").getContext("2d");
...
function clock() {
  let now = new Date();
  let ctx = document.getElementById("canvasReloj").getContext("2d");
  ctx.save();
...
img.src = "imagenes/capitan_meadows_yosemite_national_park.jpg";
let CanvasXSize = 800;
let CanvasYSize = 200;
